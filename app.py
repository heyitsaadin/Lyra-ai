...
def generate_image(prompt):
    ...
    # Add a seed for variety and nologo to keep it clean
    ...
    return (
        ...
        f'onerror="this.parentElement.innerHTML=\'❌ Could not generate image. Try again.\'">'
        f'<div class="jarvis-img-caption">🎨 {prompt}</div>'
        f'</div>'
    )
