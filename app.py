...
action = "web_search"
→ Use when the user asks about current events, news, real-time info, prices, scores, weather, or anything that needs up-to-date information beyond your training data.
→ Also use when user asks "search for", "look up", "google", "find info about", "latest", "recent", "right now", "today's" for factual topics.
→ Set reply to a clean optimized search query (e.g. "iPhone 17 release date 2025", "gold price today").
→ image_prompt should be empty string.
